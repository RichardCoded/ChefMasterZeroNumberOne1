...
public class Message implements Serializable{
    ...
    public static final int REGISTER     = 3; // Register this client in the database and continue with the login procedure
    ...
    public static final int ERROR         = 8; // Show an error message
    ...
    public Message(int type, String sender, String content, String receiver,
            String room) {
        this.type = type;
        this.sender = sender;
    ...
    public String toString() {
        return "Message [type=" + type + ", sender=" + sender + ", content="
                + content + ", receiver=" + receiver + ", room=" + room + "]";
    }
    public int getType() {
        return type;
    }
